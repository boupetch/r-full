...
RUN export DEBIAN_FRONTEND=noninteractive DEBCONF_NONINTERACTIVE_SEEN=true \
  ...
  && apt-get install -y \
    ...
    libftgl2 libfreetype6-dev libcgal-dev unzip libv8-dev libjq-dev libgdal-dev protobuf-compiler python-pip python-virtualenv libmagick++-dev \
  ...
  && R -e "install.packages(c('shiny', 'dplyr','chron','leaflet.extras','plotly', \
                            ...
                            'devtools', 'randomForest', 'foreach', 'doParallel', 'doMC', 'leaflet', \
                            'Rlibeemd', 'bigsplines', 'phonTools', 'quadprog', 'visNetwork', \
                            ...
                            'DT','threejs', 'magick','RcppRedis','reshape','wesanderson'), \
